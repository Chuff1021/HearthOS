...
const statusConfig: Record<string, { label: string; color: string; bg: string }> = {
  ...
  driving: { label: "Driving", color: "#2563eb", bg: "rgba(37,99,235,0.12)" },
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-medium" style={{ background: "rgba(22,163,74,0.1)", border: "1px solid rgba(22,163,74,0.2)", color: "#16a34a" }}>
                ...
                return (
                  ...
                  >
                    <div
                      ...
                      style={{
                        background: job.priority === "urgent" ? "rgba(220,38,38,0.9)" : "rgba(37,99,235,0.9)",
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              <div className="px-4 py-3" style={{ borderTop: "1px solid var(--color-border)", borderBottom: "1px solid var(--color-border)" }}>
                <h3 className="font-semibold text-sm" style={{ color: "var(--color-text-primary)" }}>
                  Unassigned Jobs
                  <span className="ml-2 text-xs px-1.5 py-0.5 rounded-full" style={{ background: "rgba(220,38,38,0.12)", color: "#dc2626" }}>
                ...
                {unassignedJobs.map((job) => (
                  <div
                    ...
                    style={{
                      ...
                      border: `1px solid ${job.priority === "urgent" ? "rgba(220,38,38,0.4)" : "var(--color-border)"}`,
                    }}
                  >
                    <div className="flex items-start justify-between">
                      <div>
                        <div className="flex items-center gap-1.5">
                          {job.priority === "urgent" && (
                            <span className="text-[10px] font-bold px-1.5 py-0.5 rounded" style={{ background: "rgba(220,38,38,0.12)", color: "#dc2626" }}>
                              URGENT
                            </span>
                          )}
