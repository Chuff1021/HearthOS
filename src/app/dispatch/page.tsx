      ...
      >
        ...
        <nav className="flex-1 p-3 space-y-1">
          {[
            ...
            { href: "/dispatch", label: "Dispatch", icon: "🗺️", active: true },
                ...
                return (
                  ...
                  >
                    <div
                      ...
                      style={{
                        background: job.priority === "urgent" ? "rgba(248,113,113,0.9)" : "rgba(249,115,22,0.9)",
            ...
            {selectedTech && (
              ...
              >
                ...
                <div className="flex gap-2">
                  ...
                  <button className="flex-1 px-3 py-1.5 rounded-lg text-xs font-medium" style={{ background: "linear-gradient(135deg, #f97316, #ea6c0a)", color: "white" }}>
                    + Assign Job
                  </button>
                </div>
              </div>
