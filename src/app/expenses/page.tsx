                  ...
                  <tbody>
                    {(data?.expenses || []).map((expense) => (
                      <tr key={expense.id} className="border-b last:border-0" style={{ borderColor: "var(--color-border)" }}>
                        ...
                        <td className="px-5 py-4"><a href={`/api/expenses/${expense.id}/receipt`} target="_blank" rel="noreferrer" className="billing-receipt-link inline-flex items-center gap-1.5 text-sm font-semibold" style={{ color: "var(--color-ember)" }}>View <ExternalLink size={14} /></a></td>
