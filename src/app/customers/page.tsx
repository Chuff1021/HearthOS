            ...
            >
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="rounded-lg p-3" style={{ background: "var(--color-surface-2)", border: "1px solid var(--color-border)" }}>
                    <div className="text-lg font-bold" style={{ color: "#22c55e" }}>${selectedCustomer.totalRevenue.toLocaleString()}</div>
                    <div className="text-xs" style={{ color: "var(--color-text-muted)" }}>Total Revenue</div>
                  </div>
                  {selectedCustomer.balance > 0 && (
                    <div className="col-span-2 rounded-lg p-3" style={{ background: "rgba(248,113,113,0.08)", border: "1px solid rgba(248,113,113,0.2)" }}>
                      <div className="text-lg font-bold" style={{ color: "#f87171" }}>${selectedCustomer.balance.toLocaleString()}</div>
                      <div className="text-xs" style={{ color: "#f87171" }}>Outstanding Balance</div>
                    </div>
                  )}
                </div>
