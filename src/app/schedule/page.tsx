...
const mockTechs = [
  { id: "tech-001", name: "Mike Johnson", color: "#3b82f6", initials: "MJ" },
  { id: "tech-002", name: "Sarah Williams", color: "#10b981", initials: "SW" },
  { id: "tech-003", name: "Tom Davis", color: "#f59e0b", initials: "TD" },
  { id: "tech-004", name: "Chris Lee", color: "#8b5cf6", initials: "CL" },
];
      ...
      >
        ...
        <nav className="flex-1 p-3 space-y-1">
          {[
            ...
            { href: "/schedule", label: "Schedule", icon: "📅", active: true },
        ...
        <div className="p-3 border-t" style={{ borderColor: "var(--color-border)" }}>
          <div className="text-xs font-semibold mb-2" style={{ color: "var(--color-text-muted)" }}>TECHNICIANS</div>
            ...
            {mockTechs.map((tech) => (
              <button
                ...
                style={{
                  ...
                  opacity: selectedTechs.includes(tech.id) ? 1 : 0.5,
                }}
              >
                <div
