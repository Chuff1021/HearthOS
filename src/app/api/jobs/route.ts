...
const seedJobs: Job[] = [
  ...
  },
  {
    ...
    assignedTechs: [{ id: "tech-002", name: "Sarah Williams", color: "#0d9488" }],
    totalAmount: 0,
  ...
  },
  {
    ...
    assignedTechs: [{ id: "tech-003", name: "Tom Davis", color: "#b7791f" }],
    totalAmount: 425.00,
  ...
  },
  {
    ...
    scheduledTimeEnd: "12:00",
    assignedTechs: [
      { id: "tech-001", name: "Mike Johnson", color: "#0ea5e9" },
      { id: "tech-004", name: "Chris Lee", color: "#7c3aed" },
    ],
    totalAmount: 550.00,
    createdAt: "2026-02-20T10:00:00Z",
