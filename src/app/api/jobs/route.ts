...
const seedJobs: Job[] = [
  ...
  },
  {
    ...
    assignedTechs: [{ id: "tech-002", name: "Sarah Williams", color: "#15803d" }],
    totalAmount: 0,
  ...
  },
  {
    ...
    assignedTechs: [{ id: "tech-003", name: "Tom Davis", color: "#c2410c" }],
    totalAmount: 425.00,
  ...
  },
  {
    ...
    scheduledTimeEnd: "12:00",
    assignedTechs: [
      { id: "tech-001", name: "Mike Johnson", color: "#1e40af" },
      { id: "tech-004", name: "Chris Lee", color: "#1e40af" },
    ],
    totalAmount: 550.00,
    createdAt: "2026-02-20T10:00:00Z",
