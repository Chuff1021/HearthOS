...
export async function GET() {
  const accessDenied = await authorizeCrmApi("/api/projects", "GET");
...
export async function POST(request: NextRequest) {
  const accessDenied = await authorizeCrmApi("/api/projects", "POST");
  if (accessDenied) return accessDenied;
  try {
    const access = await requireInternalUser();
    if (!access.ok) return access.response;
...
export async function PUT(request: NextRequest) {
  const accessDenied = await authorizeCrmApi("/api/projects", "PUT");
  if (accessDenied) return accessDenied;
  try {
    const access = await requireInternalUser();
    if (!access.ok) return access.response;
...
export async function DELETE(request: NextRequest) {
  const accessDenied = await authorizeCrmApi("/api/projects", "DELETE");
  if (accessDenied) return accessDenied;
  try {
    const access = await requireInternalUser();
    if (!access.ok) return access.response;
