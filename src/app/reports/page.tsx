...
const reports: ReportCard[] = [
  ...
  },
  {
    ...
    description: "What you owe vendors, with overdue tracking.",
    status: "soon",
    icon: "📤",
  },
  {
    ...
    description: "Top customers by revenue, with margin and frequency.",
    status: "soon",
    icon: "🏆",
  },
  {
    ...
    title: "Sales by Item",
    description: "Top-selling parts and services. Identify your highest-margin SKUs.",
    status: "soon",
    icon: "📦",
  },
  {
    ...
    title: "Cash Flow",
    description: "Money in (payments) vs money out (bills paid) over time.",
    status: "soon",
    icon: "💵",
  },
];
